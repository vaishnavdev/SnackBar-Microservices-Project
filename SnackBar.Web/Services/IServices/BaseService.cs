...
namespace SnackBar.Web.Services.IServices
{
    public class BaseService : IBaseService
    {
        ...
        public async Task<T> sendAsync<T>(ApiRequest apiRequest)
        {
            try
            {
                var client = this._httpClientFactory.CreateClient("SnackBarAPI");
                ...
                {
                    case StaticDetails.ApiType.POST: message.Method = HttpMethod.Post;
                        break;
                    case StaticDetails.ApiType.PUT: message.Method = HttpMethod.Put;
                        break;
